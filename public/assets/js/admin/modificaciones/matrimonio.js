$().ready(function(){   
    ...
    arraybtnmat = ["btnb1", "btnb2", "btnb3", "btnb4", "btnb5"];
    array_horas_mat = ["12:00", "13:00", "14:00", "17:00", "18:00"];
    hora = $("#hora_boda").val();
    btn = arraybtnmat[array_horas_mat.indexOf(hora)];
    cambiar_hora_boda(hora, btn);
    tabs();
    ...
    $("#fecha_boda").change(function () {
        ...
        $.ajax({
            url: $("#boton_cita_boda").attr("href"),
            type: "post",
            data: {
                "fecha": $("#fecha_boda").val(),
                "idusuario": $("#idusuario").val(),
            },
            success: function (respuesta) {
    ...
    $("#formulario").submit(function(e){
        ...
        if(!validaciones(array)){
            ...
            $.ajax({
                ...
                processData: false,
                success:function(respuesta){
                    if(respuesta.indexOf("Se Modificó el registro correctamente")!=-1){
